...
export const navGroups: NavGroup[] = [
  ...
  { id: 'trendMonitor', label: '7 · 趋势监测', itemCount: 4, hasVideo: true },
...
export const navItems: Record<string, NavItem[]> = {
  ...
  ruleConfig: [
    { id: 'rule-types', title: '规则类型介绍(普通规则 vs 高级规则)', videoTimestamp: 'V2·0:00', mdPath: 'ruleConfig/08_规则类型如何选择_普通vs高级.md' },
    { id: 'basic-rule', title: '如何配置一条普通规则', videoTimestamp: 'V2·1:00', mdPath: 'ruleConfig/09_如何配置一条普通规则.md' },
    { id: 'advanced-rule', title: '如何编写高级规则 Python 脚本', videoTimestamp: 'V2·4:00' },
    { id: 'rule-deploy', title: '规则的延迟预警与上线' },
  ],
  calcPoint: [
    { id: 'basic-calc', title: '如何创建一个普通计算测点', videoTimestamp: 'V3·0:00' },
    { id: 'advanced-calc', title: '如何编写高级计算测点脚本', videoTimestamp: 'V3·3:00' },
    { id: 'calc-rules', title: '计算测点的引用、编辑与删除规则' },
  ],
  globalTrigger: [
    { id: 'create-trigger', title: '如何创建一个全局触发器', videoTimestamp: 'V4·0:00' },
    { id: 'trigger-granularity', title: '触发器的 6 级时间粒度与预览' },
  ],
  trendMonitor: [
    { id: 'realtime-monitor', title: '如何查看实时模型监测', videoTimestamp: 'V5·0:00' },
    { id: 'curve-interpretation', title: '三色曲线解读(实际/预测/残差)' },
    { id: 'history-replay', title: '如何回放历史告警(历史仿真)', videoTimestamp: 'V5·2:00' },
    { id: 'rule-metric-monitor', title: '如何查看规则监测与指标监测', videoTimestamp: 'V5·4:00' },
  ],
  alarmMgmt: [
