  ...
  return (
    <div className="app-container">
      <header className="app-topbar">
        <Icon type="menu" className="app-topbar-hamburger" onClick={() => setDrawerOpen(true)} />
      ...
      <Drawer
        ...
        <div className="app-drawer-header">
          ...
          <Icon type="close" className="app-drawer-close" onClick={() => setDrawerOpen(false)} />
        </div>
        <Menu
          mode="inline"
